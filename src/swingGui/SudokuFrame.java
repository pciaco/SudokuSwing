...
public class SudokuFrame extends JFrame {
	...
	private JMenuBar createMenuBar() {
		...
		sixBySixGame.addActionListener(new NewGameListener(SudokuPuzzleType.SIXBYSIX,26));
		...
		twelveByTwelveGame.addActionListener(new NewGameListener(SudokuPuzzleType.TWELVEBYTWELVE,26));
		JMenuItem sixteenBySizteenGame = new JMenuItem("16 By 16 Game");
		sixteenBySizteenGame.addActionListener(new NewGameListener(SudokuPuzzleType.SIXTEENBYSIXTEEN,26));
	...
	public void rebuildInterface(SudokuPuzzleType puzzleType,int fontSize) {
		...
		clearButton.addActionListener(sPanel.new ClearActionListener());
